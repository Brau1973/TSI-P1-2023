...
namespace CrudUsuarios.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,FechaNacimiento")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,FechaNacimiento")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
